...
exports.suaKeSach = exports.themKeSach = exports.layKeSach = void 0;
...
function layKeSach(input) {
    return __awaiter(this, void 0, void 0, function* () {
        let { KE_SACH_ID = '' } = input;
        let expandCondition = "";
        if (KE_SACH_ID.trim()) {
            expandCondition += ` and ID = '${KE_SACH_ID}'`;
        }
        let sql = `
        select * 
        from ${tablename_1.TABLE_NAME.KE_SACH}
...
exports.layKeSach = layKeSach;
function themKeSach(input) {
    return __awaiter(this, void 0, void 0, function* () {
        let arrProps = Object.keys(input[0]);
        let sql = common.genInsertQuery(tablename_1.TABLE_NAME.KE_SACH, arrProps, input);
        console.log(sql);
        try {
...
function suaKeSach(input) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let sql = "";
        data.forEach((item) => {
            sql += common.genUpdateQuery(tablename_1.TABLE_NAME.KE_SACH, item, condition);
        });
        console.log(sql);
        try {
            yield common.query(sql);
